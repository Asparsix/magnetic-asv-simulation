...
class TrajectoryPlotter(Node):
    ...
    def __init__(self):
        ...
        # Estimated target: weighted centroid (primary) + discrete peak + dipole fix.
        self.est_x = None
        self.est_y = None
        self.est_p = None
        self.peak_x = None
    ...
    def on_peak(self, msg):
        ...
        # Fallback estimate until the first centroid arrives.
    ...
    def _draw_map(self):
        ...
        if self.est_x is not None and self.show_true_target:
            ...
            title += f'  |  centroid err: {err:.1f} m'
        if self.fix_x is not None and self.show_true_target:
            fix_err = math.hypot(
