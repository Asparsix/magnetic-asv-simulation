...
| `dipole_model` | `scalar_soft` | **`total_field`** |
| `target_x` | `80.0` | **`85.0`** |
| `target_y` | `-40.0` | **`40.0`** |
| `target_z` | `-1.0` | **`-1.0`** |
| `sensor_z` | `0.0` | `0.0` |
| `dipole_peak_nt` | `50.0` | `50.0` |
| `dipole_mx` / `dipole_my` / `dipole_mz` | `0` | `0` (auto vertical from peak + \(I\)) |
| `earth_inclination_deg` | `15.0` | `15.0` |
| `earth_declination_deg` | `-1.0` | `-1.0` |
| `dipole_strength_nt` | `1.5e12` | `4.0e5` (legacy `scalar_soft` only) |
| `dipole_soft_m` | `1.0` | **`11.5`** (mission-calibrated footprint) |
...
- If `plant_magnetic_target` and `dipole_model=total_field`: require pose; compute Earth \(\mathbf{F}(F,I,D)\) + vector dipole \(\mathbf{B}_d(\mathbf{r},\mathbf{m})/(r^3+s^3)\); anomaly \(\Delta F=|\mathbf{F}+\mathbf{B}_d|-|\mathbf{F}|\); add 3-axis Gaussian noise; scalar \(=|\mathbf{B}|\).
- If `dipole_model=scalar_soft`: compute \(A/(r^3+s^3)\); set \(b_z =\) background + anomaly + noise; \(b_x=b_y=0\).
...
| `dipole_model` | `scalar_soft` | **`total_field`** |
| `dipole_fit_target_z` | `-1.0` | `-1.0` |
| `dipole_fit_sensor_z` | `0.0` | `0.0` |
| `dipole_fit_free_depth` | `False` | `false` |
| `dipole_fit_free_moment` | `False` | `false` |
| `earth_inclination_deg` | `15.0` | `15.0` |
| `earth_declination_deg` | `-1.0` | `-1.0` |
| `earth_total_nt` | `45000.0` | `45000.0` |
| `dipole_fit_guess_peak_nt` | `50.0` | `50.0` |
| `dipole_soft_m` | `20.0` | **`11.5`** |
| `dipole_fit_min_anomaly_nt` | `10.0` | `10.0` |
| `dipole_fit_min_samples` | `12` | `12` |
| `dipole_fit_max_samples` | `400` | `400` |
| `dipole_fit_guess_strength_nt` | `4.0e5` | `4.0e5` (legacy `scalar_soft`) |
...
- Dipole fitter: buffer strong anomalies; LM total-field fit \((t_x,t_y,\mathbf{m})\) (or legacy \(A/(r^3+s^3)\)) seeded from centroid → continuous fix.
...
| `verify_orbit_radius_m` | `20.0` | **`0.6`** |
